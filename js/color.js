...
this.iColorPicker = function() {
    jQuery("input.iColorPicker").each(function(i) {
        ...
        jQuery(this).css("backgroundColor", jQuery(this).val()).after('<a href="javascript:void(null)" style="margin-left:-20%; line-height:40px;" id="icp_' + this.id + '" onmouseenter="iColorShow(\'' + this.id + '\',\'icp_' + this.id + '\')"><img src="' + imageUrl + '" style="border:0;margin:0 0 0 3px" align="absmiddle" ></a>')
    })
};
